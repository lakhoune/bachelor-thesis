...
\footnotetext{GraphQL: \url{https://graphql.github.io/}}
...
\footnotetext{\url{https://www.howtographql.com/basics/1-graphql-is-the-better-rest}}
...
\footnotetext{\url{http://spec.graphql.org/June2018/}}
Many different implemtentions have been written for programming languages like Java \footnote{Java GraphQL Library:\url{https://www.graphql-java.com/documentation/master/}} and Javascript. \footnote{Javascript GraphQL Library:\url{https://www.npmjs.com/package/express-graphql}}

Transforming an existing REST API into a GraphQL API can be a cumbersome task. An automation process in the form of a Wrapper has been proposed, which converts an existing schema such as a Swagger schema into a GraphQL schema\footnotemark. Such a wrapper transforms GraphQL requests into RESTful requests as depicted in Figure \ref{fig:graphqlWrapper}.
\footnotetext{\url{https://github.com/yarax/swagger-to-graphql}}
\begin{figure}[h]
	\centering
