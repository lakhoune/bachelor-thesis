...
Members of CoPs do not have to belong to the same organization, but rather participate in common work through the use of social networks \cite{CuZe05}. CoPs can be overlapping and multiple communities can exist inside a single CoP.
