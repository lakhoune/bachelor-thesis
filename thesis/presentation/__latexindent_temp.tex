...
\begin{frame}{The requirements of the community}
  \begin{columns}
    ...
    \begin{column}[]{0.35\textwidth}
      % \begin{itemize}
      %   \item 38 Participants
      %   \item 65\% male
      %   \item 32\% female
      %   \item 3\% diverse
      %   \item Aged between 20 and 53 with an average of 23.68
      %   \item 89\% students
      %   \item 11\% researchers
      %   \item 
      % \end{itemize}
      \begin{figure}
        ...
        \includegraphics[height=.35\textheight]{eval/gender1.png}
       
      \end{figure}
      \begin{figure}
        \captionsetup{justification=raggedright}
        \caption{Role of participants}
        \includegraphics[height=.35\textheight]{eval/role1.png}
  ...
  \begin{columns}
    ...
    \begin{column}[]{.35\textwidth}
      \begin{figure}
        \captionsetup{justification=raggedright}
        \caption{Gender of participants}
        \includegraphics[height=.35\textheight]{eval/gender2.png}
       
      \end{figure}
      \begin{figure}
        \captionsetup{justification=raggedright}
        \caption{Role of participants}
        \includegraphics[height=.35\textheight]{eval/role2.png}
