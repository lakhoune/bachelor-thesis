  ...
  \begin{itemize}
    ...
    \item It is difficult to measure and evaluate those factors
          \begin{itemize}
            ...
            \item Less ressources in long-tail communities
            \item Time consuming
          \end{itemize}
...
\begin{frame}{Communities of Practice}
  ...
  \begin{itemize}
    ...
    \item CoPs use Communitiy Information Systems to structure their work
...
\begin{frame}{Evaluation of visualization task}
  \begin{columns}
    \begin{column}[t]{0.5\textwidth}
      \input{../plots2/visualization.tex}
    \end{column}
    \begin{column}[t]{0.5\textwidth}
      \input{../plots2/visualization3.tex}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{Evaluation of success modeling task}
      ...
      % \input{../plots2/success2.tex}
   
\end{frame}

\begin{frame}{Discussion}
  \begin{itemize}
    \item Overall, the chatbot is usefull for simple tasks
    ...
    \item Solution: introduce \emph{Gamification}
    \begin{itemize}
      \item Visualization of Top contributers 
    \end{itemize}
  \end{itemize}
\end{frame}
