...
%   \end{block}
  \begin{itemize}
    ...
    \end{itemize}
    \item CoPs make the learning process easier \cite{SaAr05} and faster \cite{CuZe05}
    ...
    \begin{columns}
        \begin{column}[t]{0.4\textwidth}
            \begin{figure}
                ...
                \includegraphics[width=\textwidth]{realization/bot/visual_alt1.png} 
            \end{figure}
        \end{column}
        \begin{column}[t]{0.4\textwidth}
            \begin{figure}
              
                \includegraphics[width=\textwidth]{realization/bot/visual_alt2.png} 
            \end{figure}
        \end{column}
    \end{columns}
\end{frame}
