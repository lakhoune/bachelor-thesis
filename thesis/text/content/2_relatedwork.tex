...
The MobSOS Continuous Community Analytics (CCA) services extend the MobSOS framework by providing visualizations of MobSOS data and the ability to add Mediabases \cite{Kers20}, which can be used for visualizations.
...
\footnotetext{\url{https://las2peer.org/}}
...
\footnotetext{\url{https://github.com/rwth-acis/mobsos-data-processing}}
...
\footnotetext{\url{https://github.com/rwth-acis/mobsos-success-modeling}}
...
\end{itemize}
\footnotetext{\url{https://developers.google.com/chart}}
...
\footnotetext{\url{https://github.com/rwth-acis/las2peer-social-bot-manager-service}}
...
\footnotetext{\url{https://rasa.com/docs/rasa/glossary\#intent}}
...
\footnotetext{\url{https://docs.docker.com/docker-hub/}}
...
\footnotetext{\url{https://kubernetes.io/}}
