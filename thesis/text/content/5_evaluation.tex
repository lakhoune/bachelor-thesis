...
A measure catalog with example measures was added for the community by us. We created the measures according to the success factors in Listing \ref{lst:successModel}.
...
% This task should be performed in the original MobSOS CCA frontend and a group chat containing the bot.
...
For this section, we evaluated the general usability of the mensabot. We used the System Usability Scale (SUS).
