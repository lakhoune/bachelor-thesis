...
We could also use the Slack API to get workspace analytics\footnotemark.
Those analytics could be added to MobSOS to get more community insights.

\footnotetext{\url{https://api.slack.com/methods/admin.analytics.getFile}}
